...
project = u'dustmaps'
copyright = u'2016, Gregory M. Green'
author = u'Gregory M. Green'
...
latex_documents = [
    (master_doc, 'dustmaps.tex', u'dustmaps Documentation',
     u'Gregory M. Green', 'manual'),
]
...
man_pages = [
    (master_doc, 'dustmaps', u'dustmaps Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'dustmaps', u'dustmaps Documentation',
     author, 'dustmaps', 'One line description of project.',
     'Miscellaneous'),
]
